...
void run_tests() {
    ...
    assert(repository.get_position_of_application(app2) == -1);
    repository.update_application(app1, name2, 256, 1);
    Application new_app(name2, 256, 1);
    ...
    service.update_application(1, name2, 512, 1);
    Application updated_app(name2, 512, 1);
